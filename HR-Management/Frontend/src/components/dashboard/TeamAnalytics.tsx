...
import type { TeamMember } from "../../lib/dashboardMockData";
        ...
        {filtered.map((member, idx) => (
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="truncate text-xs font-normal text-gray-500">{member.position}</p>
            </div>
        ...
        <table className="w-full min-w-[480px] border-collapse text-sm">
          <thead>
            <tr className="bg-brand-light/60 text-left text-xs font-medium uppercase tracking-wide text-gray-500">
              ...
              <th className="rounded-r-lg px-4 py-3">Position</th>
            </tr>
          </thead>
          <tbody>
            {filtered.map((member, idx) => (
