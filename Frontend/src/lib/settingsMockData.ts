...
let shifts: Shift[] = [
  { shiftId: uuid(), name: "General Shift", startTime: "09:00", endTime: "18:00", gracePeriodMinutes: 15, status: "active", createdAt: "2024-01-08" },
  { shiftId: uuid(), name: "Morning Shift", startTime: "06:00", endTime: "14:00", gracePeriodMinutes: 10, status: "active", createdAt: "2024-01-08" },
  { shiftId: uuid(), name: "Evening Shift", startTime: "14:00", endTime: "22:00", gracePeriodMinutes: 10, status: "active", createdAt: "2024-01-08" },
  { shiftId: uuid(), name: "Night Shift", startTime: "22:00", endTime: "06:00", gracePeriodMinutes: 15, status: "active", createdAt: "2024-01-08" },
];
...
export const mockShiftsApi = {
  ...
  async create(payload: Pick<Shift, "name" | "startTime" | "endTime" | "gracePeriodMinutes" | "status">): Promise<Shift> {
    await delay();
  ...
  async update(
    id: string,
    payload: Pick<Shift, "name" | "startTime" | "endTime" | "gracePeriodMinutes" | "status">,
  ): Promise<Shift> {
    await delay();
