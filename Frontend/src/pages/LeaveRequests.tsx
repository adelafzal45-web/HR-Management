...
import { adminLeaveApi, type AdminLeaveRequest, type AdminLeaveStatus } from "../lib/adminOpsApi";
...
export default function LeaveRequestsPage() {
  ...
  const load = () => {
    setLoading(true);
    adminLeaveApi
      .list({ search, page, pageSize, departmentId: departmentFilter, status: statusFilter })
      .then((res) => {
        setRows(res.data);
        setTotal(res.total);
      })
  ...
  return (
    <DashboardLayout title="Leave Requests" activeKey="leave-requests">
