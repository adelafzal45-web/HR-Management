  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-white">
      ...
      {/* faint architectural texture — barely visible, purely a subtle
          professional accent behind the icon/robot, not a showcased photo */}
      <img
        src={panelTexture}
        alt=""
        aria-hidden
      ...
      */}
      <div className="relative z-10 flex min-h-screen w-full flex-col bg-white/0 px-8 py-10 sm:px-16 lg:w-1/2 lg:px-24 lg:py-12">
        <img
          src={logo}
          alt="TechnoCues — Designers of the Visible"
          className="h-auto w-[164px] shrink-0 object-contain object-left sm:w-[206px]"
        />
