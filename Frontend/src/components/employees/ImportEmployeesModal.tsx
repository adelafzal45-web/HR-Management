...
export default function ImportEmployeesModal({ open, onClose, onImport }: Props) {
  ...
  return (
    <Modal open={open} onClose={handleClose} title="Import Employees" description="Upload a CSV to bulk-create employee records." maxWidth="max-w-lg">
      {result ? (
