          ...
          <div className="mb-6 flex flex-col items-center gap-3 text-center">
            {employee.profileImageUrl ? (
              <img
                ...
                className="h-20 w-20 shrink-0 rounded-full object-cover ring-1 ring-gray-100"
              />
            ) : (
              <span className="flex h-20 w-20 shrink-0 items-center justify-center rounded-full bg-brand-light text-2xl font-semibold text-brand-dark">
