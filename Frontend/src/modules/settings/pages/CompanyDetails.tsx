...
import { companyDetailsApi, type CompanyDetails } from "@/modules/settings/api/settingsApi";
...
export default function CompanyDetailsPage() {
 ...
 <label className="mb-5 block sm:col-span-2">
 <span className="mb-2 block text-[15px] font-medium text-gray-900">Working Days</span>
 <input
 ...
 className="w-full rounded-lg bg-gray-100 px-4 py-3.5 text-sm text-gray-800 outline-none placeholder:text-gray-400 focus:ring-2 focus:ring-brand/60"
 />
 {/* This field is a label, not a rule. Attendance reads the per-day
 schedule, so saying so here avoids someone typing "Mon-Sat"
 and wondering why Saturday still counts as absent. */}
 <span className="mt-2 block text-xs text-gray-500">
 Display label only — shown on documents and reports. The schedule attendance actually uses is set
 under{" "}
 <Link to="/settings/working-days" className="font-medium text-brand-dark underline">
 Working Days
 </Link>
 .
 </span>
