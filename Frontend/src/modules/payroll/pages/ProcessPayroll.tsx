...
export default function ProcessPayrollPage() {
 ...
 <p className="mt-2.5 text-xs font-medium text-gray-500 sm:mt-3.5 sm:text-sm">Total Employees</p>
 </div>
 <div className="rounded-2xl bg-white p-4 shadow-sm ring-1 ring-gray-100 sm:p-5">
 <div className="flex items-start justify-between gap-2">
 ...
 <p className="mt-2.5 text-xs font-medium text-gray-500 sm:mt-3.5 sm:text-sm">Already Paid · {monthLabel(month, year)}</p>
 </div>
 <div className="rounded-2xl bg-white p-4 shadow-sm ring-1 ring-gray-100 sm:p-5">
 <div className="flex items-start justify-between gap-2">
 ...
 <p className="mt-2.5 text-xs font-medium text-gray-500 sm:mt-3.5 sm:text-sm">Not Yet Paid</p>
 </div>
 <div className="rounded-2xl bg-white p-4 shadow-sm ring-1 ring-gray-100 sm:p-5">
 <div className="flex items-start justify-between gap-2">
 <span className="break-words text-lg font-semibold leading-tight tracking-tight text-brand-dark xs:text-xl sm:text-2xl">{money(totalPayout)}</span>
 <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-teal-50 text-teal-500 sm:h-11 sm:w-11">
 <Wallet size={20} />
 </span>
 </div>
 <p className="mt-2.5 text-xs font-medium text-gray-500 sm:mt-3.5 sm:text-sm">Total Amount to Pay</p>
 </div>
 </div>
